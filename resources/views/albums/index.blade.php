  ...
  <body>
    ...
    <div class="container py-5">
      <div class="d-flex align-items-center justify-content-between mb-5">
        <h1>Album</h1>
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-toggle="#addItem">
          Tambah
        </button>
      </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 md-3">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-8 text-secondary">{{ $item->description }}</p>
                </div>
            </div>
        </div>
        @endforeach
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('album.store')}}" method="post" enctype="multipart/form-data">
                ...
                <botton class="btn btn-primary" type="submit">Simpan</botton>
            </form>
            </div>
          </div>
        </div>
